...
All the environments are registered in the `peg_isaac` extension. They start
...
import peg_isaac.tasks  # noqa: F401


def main():
    """Print all environments registered in `peg_isaac` extension."""
